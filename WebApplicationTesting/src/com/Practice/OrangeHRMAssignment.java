...
public class OrangeHRMAssignment {
	...
	driver.manage().window().maximize();
	 ...
	 keybordActions.sendKeys("Shaik").build().perform();
	 keybordActions.sendKeys(Keys.TAB).build().perform();
	 keybordActions.sendKeys(Keys.TAB).build().perform();
	 ...
	 java.lang.Runtime.getRuntime().exec("C:\\Users\\MD\\Desktop\\Eclips\\WebApplicationTesting\\OrangeHRM.log\\orangehrmassignment.exe");
