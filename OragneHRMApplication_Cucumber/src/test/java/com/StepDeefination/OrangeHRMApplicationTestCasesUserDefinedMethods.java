...
public class OrangeHRMApplicationTestCasesUserDefinedMethods {
	...
	@Given("^User should open the Chrome Browser in the Sysyem$")
	public void user_should_open_the_chrome_Browser_in_the_Sysyem()
	{
		...
		Log.info("**** Chrome Broswer Successfully Launched ****");
	...
	public void the_User_should_close_the_Chrome_Browser_along_with_the_OrangeHRM_Application()
	{
	    
	driver.quit();
	Log.info("**** OrangeHRM Application Along with Chrome Broswer successfully Closed ****");
